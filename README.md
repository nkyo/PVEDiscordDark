...
```
~# wget https://raw.githubusercontent.com/nkyo/PVEDiscordDark/master/PVEDiscordDark.sh
~# bash PVEDiscordDark.sh install
```
Or this oneliner
```
bash <(curl -s https://raw.githubusercontent.com/nkyo/PVEDiscordDark/master/PVEDiscordDark.sh ) install
```
